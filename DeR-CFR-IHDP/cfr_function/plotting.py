...
def table_str_bin(result_set, row_labels, labels_long=None, binary=False):
    if binary:
        ...
        # cols = ['pehe', 'rmse_fact', 'rmse_cfact', 'rmse_ite', 'bias_ate', 'bias_att', 'bias_atc', 'objective', 'pehe_nn']
        cols = ['pehe', 'rmse_fact', 'rmse_cfact', 'rmse_ite', 'ate_pred', 'ate', 'bias_ate', 'att_pred', 'att', 'bias_att', 'atc_pred', 'atc', 'bias_atc', 'objective', 'pehe_nn']
